...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const activityList = [
      {
        categoryId: categories.filter((category) => {
          category.name === 'DRINKS'
        })
        [0].id, 
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Rockin the Country @ Tara Bar and Grill',
        description: "Come out for a wild night with your gals and enjoy our live band starting at 8pm. Can't wait to you guys. ",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Clover Club',
        description: "We are finally reopening after extensive remodeling. There will be multiple specials going on throughout the night on drinks and food. ",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Bitter & Twisted',
        description: "We'll be hosting our first ever ladies night. 1/2 half drinks and appetizers for all ladies ",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Cloakroom Bar',
        description: "Want to experience something different? Then c'mon in throught the candy shop backdoor to experience a talented and creative bartender who will craft a sprecial free drink for you based on the vibes he gets off of you. We promise it will be a night your group will remember for a lifetime.",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Julep Bar',
        description: "It might not be Halloween but we are hosting a costume night. Everyone in a costume will get a ticket upon entering for a free drink at the bar.",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Bar Mordecai',
        description: "C'mon by for a specially tailored menu by a michelin star chef. Come in to find out which chef!",
      ...
      },
      {
        ...
        description: 'We will be having a live band with beer pong tables and multiple games set up throughout the bars. The first 3 people to enter the bar after opening will recieve free drinks for the rest of the night',
      ...
      },
      {
        ...
        description: 'We will be taking a group of people on a special bike drive through all the popular spots in central park. There will be a few stops on the way to take bathroom breaks and breathtaking photos.',
      ...
      },
      {
        ...
        description: "Everyone's walked through vegas streets, but not alot of people have seen the top view. We guarantee it's even better than the top view from the tallest building on the strip.",
      ...
      },
      {
        ...
        description: "Come on in to see art like you've never seen before. We are one of the largest art museums in the world. We offer a collection of modern and contemporary art. Don't forget to get a souvenir for a loved one at the end of your visit.",
      ...
      },
      {
        ...
        description: "Walk through the streets of Wynwood and see murals completed by some of Miami's finest.",
      ...
      },
      {
        ...
        description: "Let's travel back in time to the 80's and enjoy some retro themed vibes. If you come dressed in an 80's outfit, there will be special tickets at the door for free giveaways.",
      ...
      {
        categoryId: categories.filter((category) => {
          category.name === 'POP UP'
        })
        [0].id,
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Rosé Pop Up',
        description: "Different vibes in every room. C'mon by and take photos like you've never taken before. It will be the experience of a lifetime. There will be special mocktails in various rooms",
      ...
      },
      {
        ...
        userId: users[Math.floor(Math.random() * users.length)].id,
        name: 'Hot Yoga',
        description: "Enjoy a private yoga session in 100 degrees and high humidity level. It'll be an experience you won't forget!",
      ...
      },
      {
        ...
        description: "Enjoy a weekend of spa and meditation. Leave feeling like a brand new self.",
      ...
      },
      {
        ...
        description: "If you have spare hands, c'mon by and help us assemble peanut butter and jelly sandwiches to distribute to the homeless. We choose a different location each time, so we won't know which location we are going till later that evening.",
      ...
      },
      {
        ...
        description: "Projectors will be set up, popcorn and drinks will be at the concession stand, and blankets all around the lawn to sit on. C'mon by and enjoy a nice movie with some great company.",
      ...
      },
      {
        ...
        description: "If you were not able to get tickets to the actual game, come by and watch the game on a 20' projector! BYOB, so come prepared. It'll definitely be better than watching it on a couch.",
