...
Router.get('/user/:user_created_id', controller.GetAllUsersAndActivitiesByUserId);
Router.get('/activity/:activity_listed_id', controller.GetAllUsersAndActivitiesByActivityId);
